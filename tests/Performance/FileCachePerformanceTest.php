...
/*
|--------------------------------------------------------------------------
| File Handler Performance Tests
|--------------------------------------------------------------------------
|
| Thresholds are conservative to avoid flaky tests on different hardware.
| Absolute thresholds ensure reasonable performance.
...
test('set 1000 keys performance', function () {
    ...
    $this->assertPerformanceAbsolute($result, 5000, 'set 1000 keys');
...
test('get 1000 keys performance (hot cache)', function () {
    ...
    $this->assertPerformanceAbsolute($result, 3000, 'get 1000 keys');
...
test('has 1000 keys performance', function () {
    ...
    $this->assertPerformanceAbsolute($result, 2000, 'has 1000 keys');
...
test('delete 1000 keys performance', function () {
    ...
    $this->assertPerformanceAbsolute($result, 5000, 'delete 1000 keys');
});
...
test('mixed set and get 500 operations performance', function () {
    ...
    $this->assertPerformanceAbsolute($result, 5000, 'mixed set+get 500 ops');
...
test('set 1000 unique keys performance', function () {
    ...
    $this->assertPerformanceAbsolute($result, 8000, 'set 1000 unique keys');
...
test('get 1000 unique keys performance', function () {
    ...
    $this->assertPerformanceAbsolute($result, 3000, 'get 1000 unique keys');
...
test('clear 1000 entries performance', function () {
    ...
    $this->assertPerformanceAbsolute($result, 2000, 'clear 1000 entries');
});
...
test('large value 1MB set and get performance', function () {
    ...
    $this->assertPerformanceAbsolute($setResult, 3000, 'large value set');
    $this->assertPerformanceAbsolute($getResult, 2000, 'large value get');
...
test('expired key has() performance', function () {
    ...
    $this->assertPerformanceAbsolute($result, 5000, 'expired key has() with lazy delete');
});
